...
fun NoteMarkCard(
    ...
    @Composable
    fun NoteMarkCardPreview() {
        /*NoteMarkTheme {
            NoteMarkCard(
                noteMark = NoteMarkUi(
                    id = "test",
                    title = "Title of Note",
                    content = "Augue non mauris ante viverra ut arcu sed ut lectus interdum morbi sed leo purus gravida non id mi aug",
                    dateText = "19 ARP",
                    createAt = OffsetDateTime.now().to,
