...
import com.yu.pl.app.challeng.notemark.core.ui.util.RequestScreenOrientation
import com.yu.pl.app.challeng.notemark.core.ui.util.ScreenOrientation
import com.yu.pl.app.challeng.notemark.core.ui.util.model.LayoutType
import com.yu.pl.app.challeng.notemark.features.presentation.note.editnote.components.EdiModeSelector
import com.yu.pl.app.challeng.notemark.features.presentation.note.editnote.components.EditNoteField
import com.yu.pl.app.challeng.notemark.features.presentation.note.editnote.components.EditNoteTopBar
import com.yu.pl.app.challeng.notemark.features.presentation.note.editnote.components.ViewerNoteField
import com.yu.pl.app.challeng.notemark.features.presentation.note.editnote.components.ViewerNoteTopBar
            ...
            LayoutType.PORTRAIT -> {
                Column(
                    ...
                    if (state.editMode == NoteEditMode.Edit) {
                        EditNoteTopBar(
                            modifier = Modifier.fillMaxWidth(),
                            onDiscard = { action(EditNoteAction.OnChangeEditMode(NoteEditMode.View)) },
                        )
                        EditNoteField(
                            modifier = Modifier.fillMaxWidth(),
                            state = state,
